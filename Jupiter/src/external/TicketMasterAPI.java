...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "QhnAxAyKPb3cjOsX1lYq7swwu6RJ0F8r";
	...
	private String getImageUrl(JSONObject event) throws JSONException {
		if (!event.isNull("images")) {
			...
			// might be several array, some of them might be empty, so need a for-loop
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			// urlencoder because use http(url) to send request
